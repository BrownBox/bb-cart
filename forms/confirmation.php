...
function bb_cart_form_confirmation($confirmation, $form, $entry) {
    ...
    } elseif (in_array('bb_cart_shipping', explode(' ', $form['cssClass'])) && class_exists('Brownbox\Config\BB_Cart') && isset(Brownbox\Config\BB_Cart::$donate_form_confirmation_url)) {
